...
En el Listado \ref{lst:playbook-deploy-servidor-remoto} se muestra un Playbook mínimo que da instrucciones a Ansible para realizar un ping a todos los anfitriones definidos.

\begin{lstlisting}[language=Python,caption={Playbook para deploy del sistema en un servidor remoto},label=lst:playbook-deploy-servidor-remoto]
---
