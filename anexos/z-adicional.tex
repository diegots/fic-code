...
No existe una gran cantidad de herramientas visuales para explorar el árbol de objetos de un PDF, al menos fáciles de descargar y gratuitas. En la imagen \ref{fig:extructura-ppdfxplorer} se presenta una de estas herramientas, PDFXplorer \footnote{\url{https://www.o2sol.com/pdfxplorer/overview.htm}}, con un ejemplo de documento cuyo único contenido es \emph{Hola mundo!}. Alternativamente también se puede analizar un PDF de forma manual con herramientas simples en la línea de comandos \cite{filodej_blog_pdfstreamcontent}.

\begin{figure}[hp!]
    \centering
    \includegraphics[width=1.0\textwidth]{imaxes/z-adicional/pdf-xplorer.PNG}
    \caption{Estructura de un PDF en PPDFXplorer}
    \label{fig:extructura-ppdfxplorer}
\end{figure}
