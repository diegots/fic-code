...
Las reglas son de la forma $A\rightarrow S$ y pueden estar formadas por símbolos terminales y no terminales \footnote{Por consenso, los símbolos no terminales se utilizan en mayúscula y en minúscula los terminales, en Bison sin empbargo el criterio es el opuesto.}. Este es un ejemplo de gramática:
\begin{center}
