...
\begin{itemize}
    ...
    \item Los alfabetos son colecciones finitas de símbolos.
...
\begin{enumerate}
    ...
    En las gramáticas regulares las producciones son de la forma \\
    $B\rightarrow aB$
    Un no terminal simpre deriva uno o varios terminales seguidos de un no terminal y la cadena vacía está en el lenguaje. De otro modo el autómata no finalizaría. Los lenguajes generados son equivalentes a las cadenas reconocidas por las expresiones regulares.
    
    Se requiere que los no terminales aparezcan a la izquierda del terminal obligatorio.
    
    \item Gramáticas independientes del contexto

    Si en la parte derecha de la regla los terminales y no terminales pueden aparecer en cualquier orden, la gramática es una Gramática Independiente del Contexto.
    
    En las Gramáticas Independientes del Contexto se permite que símbolos terminales y no terminales aparezcan en el lado derecho de la regla. Algunos lenguajes generados serán también 
