...
En este punto se tienen las regiones con sus líneas asignadas. En el módulo \verb|printer_region.py| se encuentran las funciones que toman la regiones, líneas y palabras y crean el texto que finalmente se escribirá a disco. Tomando por ejemplo la implementación para las tablas T1, los pasos que se siguen consisten en buscar todas las líneas \emph{reales} de la tabla. Por líneas reales se entienden aquellas que forman una unidad de contenido, independientemente de cuantas líneas físicas tenga dicho contenido. Actualmente se consideran las líneas de la primera columnas como líneas que indican contenido.

- Se obtienen las líneas de la primera columna, que se consideran las líneas reales
- 
