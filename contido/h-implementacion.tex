...
La generación del lenguaje intermedio se realiza por medio de una aplicación Python escrita para este propósito. El código de la aplicación está dividido en módulos de tal manera que se facilita el desarrollo y mantenimiento. Los módulos se presentan en la tabla \ref{tab:modulo-generador-codigo-intermedio}.
...
\begin{table}[ht]
    ...
    \begin{tabular}{l l}
        ...
        loopup.py & funciones para búsqueda \\
