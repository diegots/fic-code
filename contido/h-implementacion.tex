...
\begin{figure}
    ...
    %\label{fig:dependencias-flex-bison}
\end{figure}
...
\subsection{Evaluación léxico-sintáctica}
...
Para almacenar los tipos de regiones se creó el tipo \verb|region| como un \verb|strun| compuesto de un enumerado y un \verb|union|. Cuando se crea una región le asigna un tipo del enumerado y se utiliza para los datos la variable correspondiente. Más tarde en la generación se sigue el mismo mecanismo para recuperar los datos de la lista o tabla correcta.
...
% TODO Como funciona la carga dinámica? Qué facilidad se utiliza? Como se compila?


% TODO tipos de datos utilizados. Explicar que todos los procesos de generación recorren el árbol de parseo extrayendo la información necesaria

% TODO mostrar reglas léxicas y sintácticas para algún caso

% TODO tabla estática de funciones para la generación
