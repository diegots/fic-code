...
(** Bad binding exception *)
exception NoRuleApplies

(** Returns true if value is a basic numerical type *)
let rec isnumericval ctx t = match t with
    TmZero(_) -> true
  | TmSucc(_,t1) -> isnumericval ctx t1
  | _ -> false

(** Returns true is the token is recognized as a supported value *)
...
(** Performs token evaluation. Auxiliar function *)
