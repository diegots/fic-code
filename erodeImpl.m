function outputImage = erodeImpl (image, strElType, strElSize)
    ...
    leaveOnes = all(image(ee)); % if all values in image(ee) are non zero, value is 1 and 0 otherwise
    outputImage(vectorOnes) = 255 * leaveOnes;
