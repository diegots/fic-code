...
\begin{document}
 ...
 \paxinaenbranco
 \dedicatoria{A mi madre y a Laura, que me han acompañado en este viaje} % escribe neste comando o teu texto de dedicatoria
 \paxinaenbranco
 \paxinaenbranco
...
Quiero agradecer primero a mi director Carlos Dafonte la oportunidad y confianza depositadas para la realización de este proyecto. También a Pedro Lorenzo y Adolfo Pérez por la idea inicial y el apoyo en distintos momentos. Por último, a la Facultad de Informática y los profesores por todo lo recibido durante este periodo.
 ...
 \include{contido/a-introduccion}
 \include{contido/b-estado-arte}
 \include{contido/c-bases-teoricas}
 \include{contido/d-metodologia}
 \include{contido/e-fundamentos-tecnologicos}
 \include{contido/f-planificacion}
 \include{contido/g-analisis}
 \include{contido/h-implementacion}
 \include{contido/i-conclusiones} 
 ...
 \appendix
 \appendixpage
 \include{anexos/z-adicional-1}
 \include{anexos/z-adicional-2}
 %\include{anexos/z-adicional-3}
