...
(** Defined keywords, symbols and special compound symbols *)
let reservedWords = [
  (* Keywords *)
...
let create inFile stream =
  ...
  lineno := 1; start := 0; Lexing.from_channel stream (* Create a lexer buffer on the given input channel *)
